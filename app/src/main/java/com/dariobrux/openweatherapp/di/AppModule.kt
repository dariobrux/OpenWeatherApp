...
import com.dariobrux.openweatherapp.ui.main.MainRepository
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideLocationRepository(apiHelper: WeatherApiHelper, dao: WeatherDAO) = MainRepository(apiHelper, dao)
